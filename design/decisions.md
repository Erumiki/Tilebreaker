...
**Решение:** Добавить `grayWildcardPlacement` в `configs/game.json`. Когда правило включено, серые тайлы могут касаться любого соседнего края, а цветные тайлы могут касаться серого края. Остальные цвет-цвет совпадения остаются строгими.
