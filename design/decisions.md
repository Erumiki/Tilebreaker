...
**Уточнение 2026-05-09:** Playtest показал, что полный wildcard позволял поставить серый blank в место будущего цветного продолжения и тем самым незаметно сломать контур. Минимальное правило без solver: `gray can touch combat only through a blank combat edge`.
